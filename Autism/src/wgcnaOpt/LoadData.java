...
public class LoadData {
	...
	public ArrayList<String> total_gname = new ArrayList<String>();
	...
	public double[][] Load(String coex_path) throws IOException {
		...
		System.out.println(no_total + " total genes are loaded");
		all_gscan.close();
		...
		System.out.println("	Reading coexpression matrix...");
		String delimiter = ",";
		int size = 0;
